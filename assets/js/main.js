...
// ====================== REMOVE MENU MOBILE IF CLICK NAV ELEMENT ======================
...
//=====================CODING PROFILE======================
let swiperCoding = new Swiper('.coding_container',{
    lopp: true,
    grabCursor: true,
    spaceBetween: 48,
...
//             emailjs.sendForm('service_ofrd5ao','template_qn4sk6d','#contact_form','tTOqvaLvSoSKtLDKy')
//             .then(() =>{
